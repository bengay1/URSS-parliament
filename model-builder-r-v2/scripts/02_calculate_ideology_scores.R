...
cat("\nGenerating quick visualisation...\n")

plot_score_distribution(all_scores, save_path = "data/score_distribution_all.png")
plot_party_timeseries(all_scores, save_path = "data/party_timeseries.png")
