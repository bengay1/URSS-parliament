...
#
# Outputs:
#   - data/mp_slopes_15years.csv: Regression results
...
cat("\nTop 15 MPs with INCREASING ideology (shifting rightward):\n")
print(most_positive %>%
...
cat("\nTop 15 MPs with DECREASING ideology (shifting leftward):\n")
print(most_negative %>%
        dplyr::select(mp_name_id, slope, p_value, significance, years_in_parliament))
...
plot_slope_distribution(mp_slopes, save_path = "data/slope_distribution.png")
plot_career_vs_slope(mp_slopes, save_path = "data/career_vs_slope.png")
