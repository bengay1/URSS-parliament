...
#'   - Positive slope: MP's score increasing over time → moving LEFT
#'   - Negative slope: MP's score decreasing over time → moving RIGHT
#'   - Slope ≈ 0: Ideologically consistent
#'
#' @param all_scores Tibble. IRT scores with z_score and year columns
#' @param min_years Numeric. Minimum years required for inclusion (default 15)
#'
#' @return Tibble with columns: mp_name_id, slope, std_error, p_value, significance,
#'   years_in_parliament, career_span, first_year, last_year. Ordered by |slope|.
#'
